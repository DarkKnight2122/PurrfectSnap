...
import me.eternal.purrfect.ui.manager.pages.FileImportsRoot
import me.eternal.purrfect.ui.manager.pages.LoggerHistoryRoot
import me.eternal.purrfect.ui.manager.pages.ManageReposSection
...
import me.eternal.purrfect.ui.manager.pages.features.ManageRuleFeature
...
import me.eternal.purrfect.ui.manager.pages.home.RetroGameScreen
import me.eternal.purrfect.ui.manager.pages.location.BetterLocationRoot
import me.eternal.purrfect.ui.manager.pages.scripting.ScriptingRootSection
import me.eternal.purrfect.ui.manager.pages.social.LoggedStories
import me.eternal.purrfect.ui.manager.pages.social.ManageScope
import me.eternal.purrfect.ui.manager.pages.social.MessagingPreview
import me.eternal.purrfect.ui.manager.pages.social.SocialRootSection
import me.eternal.purrfect.ui.manager.pages.tracker.EditRule
import me.eternal.purrfect.ui.manager.pages.tracker.FriendTrackerManagerRoot
import me.eternal.purrfect.ui.manager.pages.tracker.FriendTrackerCatalog
import me.eternal.purrfect.ui.manager.pages.tracker.ManageFriendTrackerReposSection
import me.eternal.purrfect.ui.manager.pages.scripting.ManageScriptReposSection
...
class Routes(
    ...
    lateinit var activityLauncher: me.eternal.purrfect.ui.util.ActivityLauncherHelper
    var navigation: me.eternal.purrfect.ui.manager.Navigation? = null
    ...
    val configImportConfirmation = route(RouteInfo(CONFIG_IMPORT_CONFIRMATION_ROUTE, hasOwnTopBar = true), me.eternal.purrfect.ui.manager.pages.features.ConfigImportConfirmationScreen())
    val configExportSummary = route(RouteInfo(CONFIG_EXPORT_SUMMARY_ROUTE, hasOwnTopBar = true), me.eternal.purrfect.ui.manager.pages.features.ConfigExportSummaryScreen())
    ...
    val friendTrackerConfigExport = route(RouteInfo(FRIEND_TRACKER_CONFIG_EXPORT_ROUTE), me.eternal.purrfect.ui.manager.pages.tracker.FriendTrackerConfigExportScreen())
    val friendTrackerConfigImport = route(RouteInfo(FRIEND_TRACKER_CONFIG_IMPORT_ROUTE), me.eternal.purrfect.ui.manager.pages.tracker.FriendTrackerConfigImportScreen())
