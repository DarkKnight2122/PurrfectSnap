package me.eternal.purrfect.task
...
class AnnouncementCheckWorker(
    ...
    private fun showAnnouncementNotification() {
        val channelId = "purrfect_announcements"
        val name = inputData.getString("channel_name") ?: "Announcements"
        val descriptionText = inputData.getString("channel_description") ?: "Notifications for Purrfect announcements"
