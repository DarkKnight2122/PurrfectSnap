...
import me.eternal.purrfect.common.util.protobuf.EditorContext
...
import me.eternal.purrfect.core.util.RandomWalking
    ...
    private fun openManagementOverlay() {
        context.bridgeClient.getLocationManager().provideFriendsLocation(
            locationHistory.values.toList().mapNotNull { locationHistory ->
                ...
                me.eternal.purrfect.bridge.location.FriendLocation().also {
