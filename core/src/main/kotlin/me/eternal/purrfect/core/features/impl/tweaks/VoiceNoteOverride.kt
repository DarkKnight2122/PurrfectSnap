...
class VoiceNoteOverride: Feature("Voice Note Override") {
    override fun init() {
        ...
        Purrfect.classCache.nativeBridge.hook("createContext", HookStage.BEFORE) { param ->
        ...
        Purrfect.classCache.nativeBridge.hook("createContext", HookStage.AFTER) { param ->
            ...
            val isValdiBridge = Purrfect.classCache.nativeBridge.name == "com.snapchat.client.valdi.NativeBridge"
