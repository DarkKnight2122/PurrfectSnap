...
class AutoRead : MessagingRuleFeature("Auto Read", MessagingRuleType.AUTO_READ) {
    ...
    private fun collectUnreadMessages(conversationId: String, myId: String): List<me.eternal.purrfect.common.database.impl.ConversationMessage> {
        val unread = LinkedHashSet<me.eternal.purrfect.common.database.impl.ConversationMessage>()
        val pageSize = 200
        val maxPages = 5
        var page = 0
        while (page < maxPages) {
