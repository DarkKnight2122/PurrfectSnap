...
import me.eternal.purrfect.common.data.download.MediaEncryptionKeyPair
...
class EncryptionWrapper(
    ...
    fun decrypt(data: ByteArray): ByteArray {
        ...
        return try {
            ...
            Log.d("Purrfect", "PKCS5 failed → trying CTR")
    ...
    fun decryptImage(data: ByteArray): ByteArray {
        ...
        return try {
            ...
            Log.d("Purrfect", "CBC NoPadding failed → trying PKCS5")
