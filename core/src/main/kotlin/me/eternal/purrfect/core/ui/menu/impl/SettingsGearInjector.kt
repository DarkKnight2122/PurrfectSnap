...
import me.eternal.purrfect.core.util.ktx.getDrawable
import me.eternal.purrfect.core.util.ktx.getStyledAttributes
...
class SettingsGearInjector : AbstractMenu() {
    ...
    private fun handleChatHoldKillAction(): Boolean {
        ...
        if (selectedActions.contains("kill_purrfect")) {
            runCatching {
