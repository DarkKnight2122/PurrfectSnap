...
class AutoReply : MessagingRuleFeature("Auto Reply", MessagingRuleType.AUTO_REPLY) {
    ...
    private fun detectStoryContentType(messageContent: MessageContent?): ContentType? {
        ...
        try {
            val protoReader = me.eternal.purrfect.common.util.protobuf.ProtoReader(messageContent.content!!)
    ...
    private suspend fun buildSystemPrompt(senderId: String, contentType: ContentType?, config: me.eternal.purrfect.common.config.impl.MessagingTweaks.AutoReplyConfig, isHalfSwipe: Boolean = false): String {
