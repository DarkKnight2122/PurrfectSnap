...
object Catppuccin {
    ...
    val warmLatte = Flavor(
        ...
        surface2 = Color(0xFFDCD2DA), surface1 = Color(0xFFE2D9E2), surface0 = Color(0xFFD6CBD2),
    ...
    val softAmoled = Flavor(
        ...
        surface2 = Color(0xFF2C2932), surface1 = Color(0xFF28252E), surface0 = Color(0xFF242229),
    ...
    val nordicDeep = Flavor(
        ...
        surface2 = Color(0xFF3B4261), surface1 = Color(0xFF2F3549), surface0 = Color(0xFF24283B),
        rosewater = Color(0xFFF1D7D2), flamingo = Color(0xFFF0C6C6), pink = Color(0xFFF5BDE6),
    ...
    val royalVelvet = Flavor(
        ...
        surface2 = Color(0xFF2D2936), surface1 = Color(0xFF26222E), surface0 = Color(0xFF1D1726),
        rosewater = Color(0xFFF1D7D2), flamingo = Color(0xFFF0C6C6), pink = Color(0xFFF5BDE6),
